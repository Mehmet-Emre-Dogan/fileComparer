...
class BGworker(QThread):
    ...
    def run(self):
        ...
        i = 1
        for hash in myDict:
            if len(myDict[hash]) > 1: # The 1 of 2 difference between "listFilesAccordingToHashes.py" and this file is this if condition
                print("")
                ...
                i += 1
                print("")
        if i == 1: # The 2 of 2 difference between "listFilesAccordingToHashes.py" and this file is this if condition
